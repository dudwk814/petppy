...
!function (a) {
    ...
    function d(b) {
        ...
        var n = null !== c.minTime ? c.minTime : 0, o = null !== c.maxTime ? c.maxTime : n + v - 1;
        n > o && (o += v), o === v - 1 && "string" === a.type(c.timeFormat) && c.show2400 && (o = v);
        var p = c.disableTimeRanges, w = 0, x = p.length, z = c.step;
    ...
    function j(a, b) {
        ...
        var c = a.data("timepicker-settings"), d = t(l(a), c);
        if (null !== d) {
            var e = i(a, b, d);
            if (e) {
    ...
    function t(a, b) {
        ...
        if (!e) return null;
        var f = parseInt(1 * e[2], 10), g = e[1] || e[5], h = f, i = 1 * e[3] || 0, j = 1 * e[4] || 0;
        if (12 >= f && g) {
            var k = g == w.pm || g == w.PM;
    ...
    var v = 86400, w = {am: "am", pm: "pm", AM: "AM", PM: "PM", decimal: ".", mins: "mins", hr: "hr", hrs: "hrs"}, x = {
        appendTo: "body",
        className: null,
        ...
        roundingFunction: function (a, b) {
            ...
            var c = a % (60 * b.step), d = b.minTime || 0;
